...
--
-- Host: localhost
-- Generation Time: Jan 17, 2011 at 04:12 PM
...
INSERT INTO `User` (`loginName`, `password`, `firstName`, `lastName`, `email`) VALUES
('bwalsh', 'bling2x', 'Brendan', 'Walsh', 'bwalsh@jackandjasper.com'),
('ocorso', '2ginger', 'Owen', 'Corso', 'owen@strattonimaging.com');
...
INSERT INTO `vineyards` (`id`, `h1`, `h2`, `p`) VALUES
(1, 'Winemaking', NULL, 'Along with our team at Crushpad, The Walsh Brothers have created two distinctly different pinot noirs.  Partial steel and partial oak barrel aging has lead to a fantastic finish to each wine.'),
(2, 'La Encantada', NULL, 'La Encantada Vineyard is one of the coolest sites in the region. The vineyard is planted on a ridge which straddles the Santa Ynez River Valley and is open to the full impact of the cooling afternoon maritime breezes. The 100 acre vineyard was planted in 2000 to 96 acres Pinot Noir, 1.9 acres Pinot Blanc, and 1.5 acres Pinot Gris. La Encantada Vineyard is derived from the Monterey Formation. Soil types include: Gazos clay-loam, Ballard fine sandy-loam, and Sta. Lucia shaly clay-loam.'),
(3, 'Split Rock ', NULL, 'We work with small,  family owned, grape growers and farmers who share our values of sustainability and minimal intervention. Our single-vineyard designate Pinot Noirs come from carefully selected vineyards. The vineyards are located in prime Pinot Noir growing regions and are known for producing excellent Pinot Noir exemplifying the true characteristics of the variety and the terroir. ');
